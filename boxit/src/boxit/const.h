...
#define BOXIT_CONFIG "config"
#define BOXIT_DUMMY_FILE "dummy"
#define BOXIT_OVERLAY_PACKAGES_CONFIG "overlay_packages"
#define BOXIT_SYNC_PACKAGES_CONFIG "sync_packages"
